...
<script type="text/javascript" src="../fyp/js/submit_seat.js"></script>
<script>
        ...
        <form name="ticket" method="post" action="confirm.php">
            ...
            <div class="Info">
                ...
                <div class="card-info" id="card-info">
                    ...
                    <br>
                    <!-- name="card-no" -->
                    <input id="credit-id"  placeholder="xxxx-xxxx-xxxx-xxxx" style="text-align: center;" required>
                    <br>
                    ...
                    <br>
                    <input id="credit-info" placeholder="123" style="text-align: center;" required>
                    <hr style="width: 900px;">
                </div>
                <br>
                ...
                <div class="Info-box">
                    ...
                    <?php
                        ...
                        for ($x = 0; $x <= $totalseat-1; $x++ ) {
                            ...
                            echo "<input type='text' class='ticketID' name=".$ticketName." id=".$ticketID." value=".$ticketID." style='display:none;' >";
                            echo "<input type='text' class='seatType' name=".$passSeatType." id=".$seatType." value='' size='10' style='display:none;'>";
                ...
                <div class="Info-box">
                    ...
                    <label>Email</label>
                    <br>
                    <input type="email" name="email" id="credit-info" style="width: 70%; text-align: center;" required>
                    <br>
