      ...
      <div class="container-fluid">
                  ...
                  <div class=\"card-block\">
                    ...
                    <div class=\"row\">
                       <div class=\"col-sm-6\">
                        ...
                        <h6 class=\"text-muted f-w-400\">$StaffID</h6>
                      </div>
                      <div class=\"col-sm-6\">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="AccountPage.html">Account management</a>
            </li>
            <li class="nav-item">
    ...
    <main class="container">
        ...
        <table class="table caption-top">
          ...
          <tbody id="myTable">
                    ...
                    $SQL = $sql = "Select  * from  positionstatus PS , staffaccount SA where   PS.positionID= SA.Position ";
                    ...
                    <tr>
                        ...
                        <td>
                        <div class=\"btn-group\">
                            <a href=\'staffAC.php?StaffID=$StaffID\' class=\"btn btn-success\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\">
                            ...
                            <ul class=\"dropdown-menu\">
                                ...
                                <li><a class=\"dropdown-item\" href=\"#\">Delect</a></li>
                            </ul>
                        </div>
                         ";}
                                              ...
                                              <div class=\"col-md-4\">
                                                ...
                                                <div class=\"col-md-3\">
                                                    <label for=\"validationCustom02\" class=\"form-label\">Postion</label>
                                                      <input type=\"text\" class=\"form-control\" id=\"validationCustom01\" value=\"$positionName\" readonly>
                                                </div>
