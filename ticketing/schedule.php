...
<!-- onclick="openCity('1')" -->
    ...
    <div class="date-box">
        <button class="date-btn1" id="date-btn">11/4/2022</button>
        <button class="date-btn2" id="date-btn">12/4/2022</button>
        <button class="date-btn3" id="date-btn">13/4/2022</button>
        <button class="date-btn4" id="date-btn">14/4/2022</button>
        <button class="date-btn5" id="date-btn">15/4/2022</button>
    </div>
    <br>
    <br>
    ...
    <div class="cinema">
        ...
        <h2>Tsing Yi Cinema (TY) </h2>
            <input type="button" class="time" id="time1" value="10:30">&nbsp;
            <input type="button" class="time" id="time2" value="14:45">&nbsp;
            <input type="button" class="time" id="time3" value="16:15">
            <input type="button" class="time" id="time2" value="18:45">&nbsp;
            <input type="button" class="time" id="time2" value="21:00">&nbsp;
