...
<body class="w3-panel w3-black">
    ...
    <!-- action="payment.php" -->
    <center>
        <form class="form1" id="form1" name="form1" method="post" action="PHP/doChange.php">
        ...
        <div style="display: none;">
            ...
            <input type="text" name="oldseatID" value="<?php echo $oldseatID?>">
    ...
    <!-- php -->
    <table border="1" id="seatTable" style="display: none;">
        <tr>
            <th>Seat ID</th>
            <th>status</th>
    ...
    <script>
        ...
        function add(seatId) {
            if (selectedseats.length >= 1) {
                alert("You can not Select more than one seat !!!");
            }else{
