    ...
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="checkposition.php?movieinfo">Movie info</a>
            </li>
            <li class="nav-item">
      ...
      <nav class="navbar navbar-light bg-light">
          <form class="container-fluid justify-content-start">
              ...
              <a type="button" class="btn btn-outline-primary" href="insert.php" >
          ...
          <table class="table caption-top">
              ...
              <thead>
                  <tr>
                       ...
                       <th scope="col">Language & Subtitle</th>
              ...
              <tbody id="myTable">
              <?php
				$query = "SELECT * FROM movie mv,movietype mvt, languagestable ls  Where ls.LanguagesID =  mv.Languages and  mv.Type = mvt.TypeID ORDER BY MovieID ASC";
				...
				?>
                  <tr>
                      ...
                      <td>
                          <div class="btn-group">
                              <a class="btn btn-success" href="EditInfo.php?MovieID=<?php echo $row["MovieID"]; ?>">
                              ...
                              <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="DelMovie.php?MovieID=<?php echo $row["MovieID"]; ?>">Delete</a></li>
                              </ul>
