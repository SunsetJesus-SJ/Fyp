        ...
        <table class="table caption-top">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col">TimeOfMovie </th>
                    <th scope="col">TimeOfComment </th>
              ...
              <tbody id="myTable">
                <?php
				$query = "SELECT * FROM memberaccount ORDER BY  MemberID ASC";
                ...
                <tr>
                    ...
                    <td><?php echo $row["PointBalance"]; ?></td>
                    <td><?php echo $row["TimeOfMovie"]; ?></td>
                    <td><?php echo $row["TimeOfComment"]; ?></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="DelMember.php?MemberID=<?php echo $row["MemberID"]; ?>">Delete</a></li>
                            </ul>
                        </div>
